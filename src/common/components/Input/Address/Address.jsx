...
const Address = (props) => {
	...
	useEffect(() => {
		nodeFormData.nodeMaster.latitude = props.latitude;
		nodeFormData.nodeMaster.longitude = props.longitude;
		nodeFormData.nodeMaster.node = props.node;
		nodeFormData.nodeMaster.city = props.city;
		nodeFormData.nodeMaster.zipcode = props.zipcode;
		nodeFormData.nodeMaster.address = props.address;
		nodeFormData.nodeMaster.stateCode =  props.stateCode;
		nodeFormData.nodeMaster.countryCode = props.countryCode;
	});
				...
				<div style={ styles.address } className="address">
					...
					<div style={ styles.inputBox } className="inputBox">
						<Select
							...
							className="st" style={ styles.select }
						>
							{states.map((state) => (
								<Option key={ state.abbreviation } disabled={ state.type }
