...
function addPresets(apiOptions, presets) {
    /*
    * “@babel/preset-env”
    ...
    */
    const presetEnvConfig = Object.assign(Object.assign({ 
        ...
        targets: {}, modules: apiOptions.opts.modules, exclude: ['transform-typeof-symbol'] }, apiOptions.opts.presetEnvUseBuiltIns && { useBuiltIns: apiOptions.opts.presetEnvUseBuiltIns }), apiOptions.opts.presetEnvCoreJs && { corejs: apiOptions.opts.presetEnvCoreJs });
...
function addPlugins(apiOptions, plugins) {
    ...
    plugins.push([
        ...
        Object.assign({ corejs: apiOptions.opts.runtimeCorejs || false, helpers: false, regenerator: true, 
            // https://babeljs.io/docs/en/babel-plugin-transform-runtime#useesmodules
            // We should turn this on once the lowest version of Node LTS
            // supports ES Modules.
            useESModules: true }, apiOptions.opts.runtimeVersion && { version: apiOptions.opts.runtimeVersion })
    ]);
 ...
 * }
 */
function babelPresetConfig(api, opts = defaults) {
    const presets = [];
...
;
exports.default = babelPresetConfig;
