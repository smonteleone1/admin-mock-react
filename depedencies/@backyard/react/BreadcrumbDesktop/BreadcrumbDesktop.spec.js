...
var _BreadcrumbDesktop2 = _interopRequireDefault(require("./BreadcrumbDesktop"));
...
describe('BreadcrumbDesktop Snapshots', function () {
  test('BreadcrumbDesktop default snapshot', function () {
    var _render = (0, _testUtils.render)(_BreadcrumbDesktop || (_BreadcrumbDesktop = /*#__PURE__*/React.createElement(_BreadcrumbDesktop2["default"], {
      crumbs: crumbs,
    ...
    themes.forEach(function (theme) {
      ...
      test("BreadcrumbDesktop ".concat(theme, " theme snapshot"), function () {
        var _render2 = (0, _testUtils.render)(_ThemeProvider || (_ThemeProvider = /*#__PURE__*/React.createElement(_ThemeProvider2["default"], {
          theme: theme
        }, _React$Fragment || (_React$Fragment = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_BreadcrumbDesktop2["default"], {
          crumbs: crumbs,
          className: "custom-class-name"
        })))))),
