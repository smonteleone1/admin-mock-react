...
var _Minus2 = _interopRequireDefault(require("@backyard/icons/Minus"));

var _Plus2 = _interopRequireDefault(require("@backyard/icons/Plus"));
...
var _StepperWrapper = _interopRequireDefault(require("./styles/StepperWrapper"));
...
var Stepper = /*#__PURE__*/React.forwardRef(function Stepper(_ref, ref) {
  ...
  var shape = (0, _ThemeProvider.getShape)(shapeProp, shapeContext); // Inner Ref of `input`

  var innerRef = (0, _useForwardedRef["default"])(ref); // Controlled value of Stepper
  ...
  var handleChange = function handleChange(event) {
    ...
    if (!disabled) {
      ...
      (0, _persistSyntheticEvent["default"])(event); // New Value, unclamped until blur
      ...
      event.target = (0, _extends2["default"])({}, innerRef.current, {
        value: newValue
  ...
  var handleBlur = function handleBlur(event) {
    ...
    if (!disabled) {
      // Don't bubble up event
      (0, _persistSyntheticEvent["default"])(event); // Clamp new value to be between min and max
  ...
  var handleButtonClick = function handleButtonClick(event, action) {
    ...
    if (!disabled && isBetweenMinAndMax) {
      ...
      (0, _persistSyntheticEvent["default"])(event); // Force target to `input` instead of `IconButton`
      // eslint-disable-next-line no-param-reassign
  ...
  return /*#__PURE__*/React.createElement(_StepperWrapper["default"], (0, _extends2["default"])({
    className: "stepper--wrapper"
  }, wrapperProps, {
    style: (0, _extends2["default"])({}, stepperStyles, style, wrapperProps === null || wrapperProps === void 0 ? void 0 : wrapperProps.style)
  }), /*#__PURE__*/React.createElement("div", {
    className: "stepper--fields shape--".concat(shape, " size--").concat(size, " state--").concat(state) + (disabled ? " disabled" : "")
  }, !hideButtons ? /*#__PURE__*/React.createElement(_IconButton["default"], (0, _extends2["default"])({
    ...
    "aria-live": "polite",
    "aria-atomic": "true"
  }, decrementProps), _Minus || (_Minus = /*#__PURE__*/React.createElement(_Minus2["default"], null))) : null, /*#__PURE__*/React.createElement(_TextInput["default"], (0, _extends2["default"])({
    key: "stepper__".concat(state),
    "aria-label": ariaLabel,
    label: ariaLabel,
    hiddenLabel: true,
    className: (0, _classnames["default"])("backyard stepper", className),
    ...
    size: size,
    role: "spinbutton"
  }, props)), !hideButtons ? /*#__PURE__*/React.createElement(_IconButton["default"], (0, _extends2["default"])({
    ...
    "aria-live": "polite",
    "aria-atomic": "true"
  }, incrementProps), _Plus || (_Plus = /*#__PURE__*/React.createElement(_Plus2["default"], null))) : null), label ? /*#__PURE__*/React.createElement("label", {
    htmlFor: id,
