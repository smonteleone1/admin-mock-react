...
var _utils = require("../ListSelector/utils");

var _ListSelector = require("../ListSelector");

var _ListSelectorMultiple = require("../ListSelector/ListSelectorMultiple");

var _Select = _interopRequireDefault(require("../Select"));

var _ThemeProvider = require("../ThemeProvider");

var _MultiselectWrapper = _interopRequireDefault(require("./styles/MultiselectWrapper"));
...
var Multiselect = /*#__PURE__*/React.forwardRef(function Multiselect(_ref, ref) {
  ...
  var options = (0, _utils.getOptions)(optionsProp, children); // Calculate and hold flat options and their values

  var flatOptions = (0, _utils.flattenOptions)(options, -1);
  ...
  var contentAbove = React.useMemo(function () {
    return (// If popover content above defined or select all disabled,
      ...
      }, popoverContent === null || popoverContent === void 0 ? void 0 : popoverContent.above, !noSelectAll ? /*#__PURE__*/React.createElement(_ListSelectorMultiple.ListSelectorMultiple, {
        options: [{
          label: 'All',
          value: 'all',
          checkboxProps: {
  ...
  return /*#__PURE__*/React.createElement(_ClickAwayListener["default"], {
  ...
  }, /*#__PURE__*/React.createElement(_MultiselectWrapper["default"], {
    ...
    className: (0, _classnames["default"])(value.length > 0 && 'completed', open && 'focus'),
    options: [{
      label: '',
      value: ''
    ...
    }, contentAbove, /*#__PURE__*/React.createElement(_ListSelector.ListSelector, (0, _extends2["default"])({
      multiple: true,
