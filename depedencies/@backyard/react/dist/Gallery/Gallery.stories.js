...
exports["default"] = exports.Skeleton = exports.DisableThumbnails = exports.DisableNavigation = exports.DefaultGallery = exports.CustomGalleryLayout = exports.CustomGalleryItems = void 0;
...
var DefaultGallery = function DefaultGallery() {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_.Gallery, {
    shape: _addonKnobs.select.apply(void 0, shapes),
    excessRender: (0, _addonKnobs.text)('excessRender', 'View %max more'),
    onChange: (0, _addonActions.action)('onChange'),
    onClickNext: (0, _addonActions.action)('onClickNext'),
    onClickPrevious: (0, _addonActions.action)('onClickPrevious'),
    items: [{
...
var DisableThumbnails = function DisableThumbnails() {
  return /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, {
    start: 6,
    end: 12
  }, /*#__PURE__*/_react["default"].createElement(_.Gallery, {
...
exports.DisableThumbnails = DisableThumbnails;

var DisableNavigation = function DisableNavigation() {
  return /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, {
    start: 6,
    end: 12
  }, /*#__PURE__*/_react["default"].createElement(_.Gallery, {
...
var VideoViewer = function VideoViewer(_ref) {
  ...
  return _div || (_div = /*#__PURE__*/_react["default"].createElement("div", {
    className: "spinvview"
...
var CustomGalleryItems = function CustomGalleryItems() {
  return /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, {
    start: 6,
    end: 12
  }, /*#__PURE__*/_react["default"].createElement(_.Gallery, {
    shape: _addonKnobs.select.apply(void 0, shapes),
    excessRender: (0, _addonKnobs.text)('excessRender', 'View %current more'),
    items: [{
      original: 'http://mobileimages.lowes.com/product/converted/883049/883049354699.jpg?size=pdhi',
      thumbnail: 'http://mobileimages.lowes.com/product/converted/883049/883049354699.jpg?size=mthb',
      renderViewportItem: function renderViewportItem(props, ref) {
        ...
        }, /*#__PURE__*/_react["default"].createElement(VideoViewer, {
          data: {
      ...
      renderThumbnail: function renderThumbnail(_ref2, ref) {
        ...
        return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("img", {
          src: src,
          alt: alt
        }), _VideoThumbnailOverla || (_VideoThumbnailOverla = /*#__PURE__*/_react["default"].createElement(VideoThumbnailOverlay, null)));
      }
    }, {
      original: 'http://mobileimages.lowes.com/product/converted/883049/883049354699.jpg?size=pdhi',
      thumbnail: 'http://mobileimages.lowes.com/product/converted/883049/883049354699.jpg?size=mthb'
...
exports.CustomGalleryItems = CustomGalleryItems;

var CustomGalleryLayout = function CustomGalleryLayout() {
  return /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, {
    start: 6,
    end: 12
  }, /*#__PURE__*/_react["default"].createElement(_.Modal, {
    size: "auto"
  }, _ModalHeader || (_ModalHeader = /*#__PURE__*/_react["default"].createElement(_.ModalHeader, null, "Gallery Example")), /*#__PURE__*/_react["default"].createElement(_.ModalBody, {
    style: {
      paddingRight: '1rem',
      maxHeight: '40rem'
    }
  }, /*#__PURE__*/_react["default"].createElement(_.GalleryProvider, {
    shape: _addonKnobs.select.apply(void 0, shapes),
    excessRender: (0, _addonKnobs.text)('excessRender', 'View %excess more'),
    onChange: (0, _addonActions.action)('onChange'),
    onClickNext: (0, _addonActions.action)('onClickNext'),
    onClickPrevious: (0, _addonActions.action)('onClickPrevious'),
    items: [{
      ...
      renderThumbnail: function renderThumbnail(_ref3, ref) {
        ...
        return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("img", {
          src: src,
          alt: alt
        }), _VideoThumbnailOverla2 || (_VideoThumbnailOverla2 = /*#__PURE__*/_react["default"].createElement(VideoThumbnailOverlay, null)));
      }
    }, {
      original: 'http://mobileimages.lowes.com/product/converted/883049/883049354699.jpg?size=pdhi',
      thumbnail: 'http://mobileimages.lowes.com/product/converted/883049/883049354699.jpg?size=mthb'
  ...
  }, /*#__PURE__*/_react["default"].createElement(_.GalleryThumbnailGroup, {
    disableMobile: (0, _addonKnobs["boolean"])('disableMobile', false),
    maxThumbnails: _addonKnobs.select.apply(void 0, maxThumbnails),
    direction: "column",
    style: {
      maxHeight: '32rem'
    }
  })), _Grid$Column || (_Grid$Column = /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, null)), _Grid$Column2 || (_Grid$Column2 = /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, {
    start: 6,
    end: 12
  }, /*#__PURE__*/_react["default"].createElement(_.GalleryViewport, null))))))), _ApiLink5 || (_ApiLink5 = /*#__PURE__*/_react["default"].createElement(_ApiLink6.ApiLink, {
    to: "https://stage.carbon.gcp.lowes.com/bds/documentation/ComponentAPI/Gallery"
  })));
};

exports.CustomGalleryLayout = CustomGalleryLayout;

var Skeleton = function Skeleton() {
  return /*#__PURE__*/_react["default"].createElement(_.GridV3.Column, {
    start: 6,
    end: 12
  }, /*#__PURE__*/_react["default"].createElement(_.FormControl, null, _FormHeading || (_FormHeading = /*#__PURE__*/_react["default"].createElement(_.FormHeading, null, "Gallery Skeleton")), _br || (_br = /*#__PURE__*/_react["default"].createElement("br", null)), /*#__PURE__*/_react["default"].createElement(_.GallerySkeleton, {
    animate: (0, _addonKnobs["boolean"])('Animate', false),
    hideButtons: (0, _addonKnobs["boolean"])('Hide Buttons', false),
    thumbnails: (0, _addonKnobs.number)('Thumbnails', 5)
  })));
};
