...
var handleVisibilityChange = function handleVisibilityChange() {
  // @ts-ignore
  if (_this && _this.visibilityState === 'hidden') {
...
var teardown = function teardown(doc) {
...
var useIsFocusVisible = function useIsFocusVisible() {
  var ref = React.useCallback(function (instance) {
    var node = ReactDOM.findDOMNode(instance); // eslint-disable-line react/no-find-dom-node
