...
describe('DatePickerSkeleton Snapshots', function () {
              ...
              return _regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      wrapper = render(_ThemeProvider || (_ThemeProvider = /*#__PURE__*/React.createElement(ThemeProvider, null, /*#__PURE__*/React.createElement(DatePickerSkeleton, {
                        animate: true
                      }))));
  ...
  test('size snapshots', function () {
    ...
    sizes.forEach(function (size) {
      var _render = render( /*#__PURE__*/React.createElement(DatePickerSkeleton, {
        size: size
      })),
