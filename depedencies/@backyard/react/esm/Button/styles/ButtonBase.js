...
var Shared = css(["&.disabled{cursor:not-allowed;&:active{pointer-events:none;}}"]);
var BrowserCSS = css(["&&&{outline:none;vertical-align:bottom;height:auto;&::-moz-focus-inner{border:0;}}"]);
...
}, Variants, Shapes, Sizes, Shared, BrowserCSS);
export { ButtonBase };
