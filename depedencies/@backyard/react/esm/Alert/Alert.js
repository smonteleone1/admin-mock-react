...
var Alert = /*#__PURE__*/React.forwardRef(function Alert(_ref, ref) {
  ...
  var innerRef = useForwardedRef(ref); // Get relevant icon from icon map
  ...
  return !closed ? /*#__PURE__*/React.createElement(AlertWrapper, _extends({
    className: classNames("alert type--".concat(type, " size--").concat(size, " shape--").concat(shape), className, multiline && "multiline"),
    multiline: multiline,
    style: style
  }, props, {
    ref: innerRef
