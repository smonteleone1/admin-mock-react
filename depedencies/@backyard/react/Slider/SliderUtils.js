...
exports.axisProps = exports.Identity = void 0;
exports.clamp = clamp;
...
exports.setValueIndex = setValueIndex;
...
function roundValueToStep(value, step, min, max) {
...
function focusThumb(sliderRef, setActive) {
