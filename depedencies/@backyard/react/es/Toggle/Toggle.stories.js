...
export const ToggleMultiple = () => /*#__PURE__*/React.createElement(Grid.Column, {
  start: 6,
  end: 12
...
export const ToggleExclusive = () => /*#__PURE__*/React.createElement(Grid.Column, {
  start: 6,
  end: 12
...
export const ToggleEnforceSelected = () => /*#__PURE__*/React.createElement(Grid.Column, {
  start: 6,
  end: 12
...
export const Skeleton = () => /*#__PURE__*/React.createElement(ToggleSkeleton, {
  size: select(...sizes),
