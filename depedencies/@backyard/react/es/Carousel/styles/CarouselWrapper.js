...
const CarouselButtons = css([".carousel-button-right,.carousel-button-left{display:none;position:absolute;align-self:center;&.show-button{display:flex;}}.carousel-button-left{left:0;}.carousel-button-right{right:0;}"]);
const CarouselWrapper = styled(Scrollbar).withConfig({
