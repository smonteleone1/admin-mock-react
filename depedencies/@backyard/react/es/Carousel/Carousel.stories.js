...
})(["height:8rem;width:", ";background-color:#d2d2d2;"], ({
  width
}) => width ? `${width}rem` : `2.5rem`);
export const DefaultCarousel = () => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grid.Row, null, /*#__PURE__*/React.createElement(Grid.Column, {
  start: 6,
  end: 12,
  style: {
    marginBottom: '1rem'
