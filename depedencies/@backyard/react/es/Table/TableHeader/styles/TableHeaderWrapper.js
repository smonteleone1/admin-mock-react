...
const HeadContentOverflow = css([".cell-content{.header-content{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}&.overflow{overflow:hidden;}}"]);
const TableHeaderWrapper = styled.th.withConfig({
