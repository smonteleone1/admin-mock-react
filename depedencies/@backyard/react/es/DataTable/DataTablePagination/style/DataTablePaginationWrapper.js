...
const Sizes = css(["&.size--small{padding:var(--bds-sizes-size-5) var(--bds-sizes-size-16);}&.size--medium{padding:var(--bds-sizes-size-8) var(--bds-sizes-size-16);}&.size--large{padding:var(--bds-sizes-size-12) var(--bds-sizes-size-16);}"]);
const DataTablePaginationWrapper = styled.div.withConfig({
