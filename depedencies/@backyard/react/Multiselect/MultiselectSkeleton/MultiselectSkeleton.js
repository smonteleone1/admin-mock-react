...
exports["default"] = exports.MultiselectSkeleton = void 0;
...
var MultiselectSkeleton = /*#__PURE__*/React.forwardRef(function MultiselectSkeleton(_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(_SelectSkeleton["default"], (0, _extends2["default"])({
    className: (0, _classnames["default"])('multiselect--skeleton', className),
    variant: "rect",
    shape: shape,
    animate: animate,
    size: size
...
exports.MultiselectSkeleton = MultiselectSkeleton;
MultiselectSkeleton.bdsName = 'MultiselectSkeleton';
var _default = MultiselectSkeleton;
