...
exports["default"] = exports.TextFieldSkeleton = void 0;
...
var TextFieldSkeleton = /*#__PURE__*/React.forwardRef(function TextFieldSkeleton(_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(_Skeleton["default"], (0, _extends2["default"])({
    className: (0, _classnames["default"])('textfield--skeleton', className),
    variant: "rect",
    shape: shape,
    animate: animate,
    width: width,
...
exports.TextFieldSkeleton = TextFieldSkeleton;
TextFieldSkeleton.bdsName = 'TextFieldSkeleton';
var _default = TextFieldSkeleton;
