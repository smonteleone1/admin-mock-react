...
var _TextFieldSkeleton = _interopRequireDefault(require("./TextFieldSkeleton"));
...
describe('TextFieldSkeleton Snapshots', function () {
              ...
              return _regenerator["default"].wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      wrapper = (0, _testUtils.render)(_ThemeProvider || (_ThemeProvider = /*#__PURE__*/React.createElement(_ThemeProvider2.ThemeProvider, null, /*#__PURE__*/React.createElement(_TextFieldSkeleton["default"], {
                        animate: true
                      }))));
  ...
  test('size snapshots', function () {
    ...
    sizes.forEach(function (size) {
      var _render = (0, _testUtils.render)( /*#__PURE__*/React.createElement(_TextFieldSkeleton["default"], {
        size: size
      })),
